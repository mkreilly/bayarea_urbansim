...
* [Household Control Totals](https://github.com/BayAreaMetro/bayarea_urbansim/blob/master/data/household_controls.csv): This table represents the exogenous growth in regional households meaning that BAUS will ensure that its forecast conforms to these numbers. The values are segmented into each 5-year interval (2010 to 2050) and into four categories of  
* [Employment Control Totals](https://github.com/BayAreaMetro/bayarea_urbansim/blob/master/data/employment_controls.csv):
* [Additional Regional Control Totals](https://github.com/BayAreaMetro/bayarea_urbansim/blob/master/data/regional_controls.csv):
